  ...
  return (
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto px-6 py-8">
        ...
        <div className="space-y-8 text-[#c5c5d6]">
          <section>
            <h2 className="text-base font-semibold text-[#e3e2e5] mb-3">Temporary by design</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-[#e3e2e5] mb-3">Manual deletion</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold text-[#e3e2e5] mb-3">No account required</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold text-[#e3e2e5] mb-3">AI data processing</h2>
            <p className="text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-base font-semibold text-[#e3e2e5] mb-3">What we don&apos;t do</h2>
          ...
          <section>
            <h2 className="text-base font-semibold text-[#e3e2e5] mb-3">Acceptable use</h2>
            <p className="text-sm leading-relaxed">

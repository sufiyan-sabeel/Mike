    ...
    <section className="py-24 md:py-40 px-6 md:px-16">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Notes card */}
          <div className="bg-[#17181C] border border-[#26282C] rounded-[24px] p-8 anim-slide-up-delay-1">
          ...
          {/* Todo card */}
          <div className="bg-[#17181C] border border-[#26282C] rounded-[24px] p-8 anim-slide-up-delay-2">

      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-[#17181C] border border-[#26282C] rounded-[24px] overflow-hidden anim-slide-up-delay-1">
          ...
          <div className="flex items-center gap-3 px-6 py-4 border-b border-[#26282C]">
            ...
            <div className="ml-4 flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#0B0C0E] border border-[#26282C]">
              <span className="font-mono text-xs text-[#6E7075]">fluxdrift421@mike.dev</span>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#6E7075" strokeWidth="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 01-2-2V4a2 2 0 012-2h9a2 2 0 012 2v1"/></svg>
            </div>
            <div className="ml-auto flex items-center gap-2 text-xs text-[#6E7075]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 min-h-[400px]">
            {/* Message list */}
            <div className="border-r border-[#26282C] p-4 space-y-2">
              {[
                ...
                <div key={i} className={`p-3 rounded-[12px] cursor-pointer transition-colors ${msg.unread ? 'bg-[#6C87FF]/10 border border-[#6C87FF]/20' : 'hover:bg-[#1E2024]'}`}>
                  <div className="flex items-center justify-between mb-1">
                    <span className={`text-sm font-medium ${msg.unread ? 'text-white' : 'text-[#AEB0B4]'}`}>{msg.sender}</span>
                    <span className="text-xs text-[#6E7075]">{msg.time}</span>
                  </div>
                  <p className="text-xs text-[#AEB0B4] truncate">{msg.subject}</p>
                  {msg.code && (
            ...
            <div className="p-6">
              ...
              <p className="text-xs text-[#6E7075] mb-4">From: notifications@github.com</p>
              <div className="text-sm text-[#AEB0B4] leading-relaxed space-y-3">
                <p>Hello,</p>
                <p>Please verify your email address by entering the following code:</p>
                <div className="py-4 text-center">
                  <span className="font-mono text-3xl font-bold tracking-[0.1em] text-white">482913</span>
                </div>
            ...
            {/* AI Panel */}
            <div className="border-l border-[#26282C] p-4 space-y-4">
